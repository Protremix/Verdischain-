#!/usr/bin/env python3
"""Update IBC tests to use RawOrigin::Root for governance-gated functions."""

import subprocess

new_tests = r'''use crate::*;
use frame_support::{
...
proc = subprocess.Popen(
    ["ssh", "root@91.98.160.145", "cat > /opt/verdis-chain-rust/pallets/ibc/src/tests.rs"],
    stdin=subprocess.PIPE,
    stdout=subprocess.PIPE,
    stderr=subprocess.PIPE,
    text=True
)
stdout, stderr = proc.communicate(input=new_tests, timeout=30)
