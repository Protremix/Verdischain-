...
const footerNav = {
  Product: [
    ...
    { name: 'Monitoring', href: '/app/monitoring' },
    { name: 'Security', href: '/app/security' },
  ],
  Platform: [
    { name: 'API Docs', href: '/app/docs' },
    { name: 'Pricing', href: '/pricing' },
    { name: 'Changelog', href: '/app/activity' },
    { name: 'Status', href: '/app/monitoring' },
  ],
  Company: [
    { name: 'About', href: '/#features' },
    { name: 'Privacy', href: '/#features' },
    { name: 'Terms', href: '/#features' },
