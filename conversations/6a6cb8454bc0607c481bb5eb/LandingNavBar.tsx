      ...
      <div className={cn(
        ...
        {mobileOpen && (
          <div className="lg:hidden border-t border-border p-4 space-y-2 animate-fade-in">
            ...
            <Link to="/login" className="block py-2 text-sm text-text-secondary hover:text-text-primary">Log in</Link>
            <Link to="/register" className="block py-2 text-sm font-medium text-brand">Get Started →</Link>
          </div>
        )}
      </div>
    </header>
