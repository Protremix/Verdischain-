...
class StakeFragment : Fragment() {
    ...
    private var rvValidators: RecyclerView? = null
    private var tvYourStake: TextView? = null
    private var tvRewards: TextView? = null
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        rvValidators = null; tvYourStake = null; tvRewards = null
        btnClaim = null; swipeRefresh = null
    }
}
