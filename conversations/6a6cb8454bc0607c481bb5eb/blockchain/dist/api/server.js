  ...
  <div class="footer">
    ...
    <p style="margin-top:0.5rem">Built with @noble/secp256k1 and @noble/hashes. No mocks. No third-party dependencies.</p>
        ...
        this.app.get('/whitepaper', (req, res) => {
            const p = path_1.default.resolve(__dirname, '../web/whitepaper.html');
        ...
        this.app.get('/docs', (req, res) => {
            const p = path_1.default.resolve(__dirname, '../web/api-docs.html');
            if (fs_1.default.existsSync(p)) {
                res.sendFile(p);
                return;
            }
        ...
        this.app.get('/status', (req, res) => {
            const p = path_1.default.resolve(__dirname, '../web/status.html');
            if (fs_1.default.existsSync(p)) {
                res.sendFile(p);
                return;
            }
        ...
        this.app.get('/ecosystem', (req, res) => {
            const p = path_1.default.resolve(__dirname, '../web/ecosystem.html');
            if (fs_1.default.existsSync(p)) {
                res.sendFile(p);
                return;
            }
        ...
        this.app.get('/templates', (req, res) => {
            const p = path_1.default.resolve(__dirname, '../web/templates.html');
            if (fs_1.default.existsSync(p)) {
                res.sendFile(p);
                return;
            }
