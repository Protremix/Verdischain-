...
new_genesis = r'''fn genesis_config() -> verdis_runtime::RuntimeGenesisConfig {
    use verdis_runtime::{
    ...
    // Ecosystem 30B + Staking 20B + Treasury 15B + Development 10B + Liquidity 10B
    ...
    let genesis_balances: Vec<(AccountId, u128)> = vec![
        ...
        // Validator stakes (21 validators x 10K VRDX each)
...
categories = {
    'Ecosystem': 30, 'Staking': 20, 'Treasury': 15, 'Development': 10,
...
# Also verify validator count
validator_count = 21
validator_stake_total = validator_count * 10  # 10K each = 210K
team_for_alice = 5_000_000_000 - validator_stake_total
print(f"\nValidators: {validator_count}")
print(f"Validator stake total: {validator_stake_total}K VRDX")
print(f"Alice (Team) receives: {team_for_alice:,} VRDX")
