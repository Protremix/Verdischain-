...
guide_content = """# Verdis Chain SDK Developer Guide: Building Eco-Friendly Decentralized Applications
...
with open("/tmp/verdis-repo/sdk/VERDIS-SDK-GUIDE.md", "w") as f:
    f.write(guide_content)

print("Successfully generated /tmp/verdis-repo/sdk/VERDIS-SDK-GUIDE.md")
