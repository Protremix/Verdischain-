...
# Batch audit: DEX, Eco, Fungible Tokens, Presale, Vesting, Tokenomics
pallets = [
    ("pallets/pallets_amm-dex_src_lib.txt", "audit_amm_dex.md"),
    ("pallets/pallets_eco_src_lib.txt", "audit_eco.md"),
    ("pallets/pallets_fungible-tokens_src_lib.txt", "audit_fungible_tokens.md"),
