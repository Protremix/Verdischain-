...
use sc_service::{
    error::Error as ServiceError, BuildNetworkParams, Configuration, TaskManager,
    WarpSyncConfig,
};
...
> {
    ...
    let babe_config = sp_consensus_babe::BabeApi::configuration(&*client)
    ...
    let (block_import, babe_link) = sc_consensus_babe::block_import(
        ...
        select_chain.clone(),
        OffchainTransactionPoolFactory::new(Arc::new(transaction_pool.clone())),
    )?;
...
pub fn new_full(config: Configuration) -> Result<TaskManager, ServiceError> {
    ...
    if role.is_authority() {
        ...
        let babe = sc_consensus_babe::start_babe(sc_consensus_babe::BabeParams {
            ...
            babe_link: sc_consensus_babe::BabeLink::default(),
