...
use frame_support::traits::{
    tokens::{
        ...
        BalanceStatus, DepositConsequence, ExistenceRequirement, Fortitude, Preservation,
...
impl Currency<AccountId> for MaxSupplyCurrency {
    ...
    #[inline]
    fn can_slash(who: &AccountId, v: Self::Balance) -> bool {
        <Balances as Currency<AccountId>>::can_slash(who, v)
    }
    #[inline]
    ...
    fn active_issuance() -> Self::Balance {
        <Balances as Currency<AccountId>>::active_issuance()
    }
    #[inline]
    ...
    fn make_free_balance_be(
        ...
        if Self::check_increase(current, value).is_err() {
            let max_increase = TOTAL_SUPPLY
                .checked_sub(<Balances as Currency<AccountId>>::total_issuance())
...
impl ReservableCurrency<AccountId> for MaxSupplyCurrency {
    #[inline]
    fn can_reserve(who: &AccountId, v: Self::Balance) -> bool {
        Balances::can_reserve(who, v)
    }
    #[inline]
    fn slash_reserved(
        who: &AccountId,
    ...
    #[inline]
    fn reserve(who: &AccountId, v: Self::Balance) -> DispatchResult {
        Balances::reserve(who, v)
    }
    #[inline]
    fn unreserve(who: &AccountId, v: Self::Balance) -> Self::Balance {
        Balances::unreserve(who, v)
    }
    #[inline]
...
impl fungible::Inspect<AccountId> for MaxSupplyCurrency {
    ...
    #[inline]
    fn total_issuance() -> Self::Balance {
        <Balances as fungible::Inspect<AccountId>>::total_issuance()
    }
    #[inline]
    fn active_issuance() -> Self::Balance {
        <Balances as fungible::Inspect<AccountId>>::active_issuance()
    }
    #[inline]
    fn minimum_balance() -> Self::Balance {
        <Balances as fungible::Inspect<AccountId>>::minimum_balance()
    }
    #[inline]
    fn total_balance(who: &AccountId) -> Self::Balance {
        <Balances as fungible::Inspect<AccountId>>::total_balance(who)
    }
    #[inline]
    fn balance(who: &AccountId) -> Self::Balance {
        <Balances as fungible::Inspect<AccountId>>::balance(who)
    }
...
impl fungible::Unbalanced<AccountId> for MaxSupplyCurrency {
    ...
    fn set_total_issuance(amount: Self::Balance) {
        if amount > TOTAL_SUPPLY {
            panic!(
                "MaxSupplyCurrency::set_total_issuance: {} exceeds cap {}",
                amount, TOTAL_SUPPLY
            );
        }
    ...
    fn deactivate(amount: Self::Balance) {
        <Balances as fungible::Unbalanced<AccountId>>::deactivate(amount)
    }
    #[inline]
    fn reactivate(amount: Self::Balance) {
        <Balances as fungible::Unbalanced<AccountId>>::reactivate(amount)
    }
}
...
impl fungible::InspectHold<AccountId> for MaxSupplyCurrency {
    ...
    fn total_balance_on_hold(who: &AccountId) -> Self::Balance {
        Balances::total_balance_on_hold(who)
    }
    #[inline]
    fn reducible_total_balance_on_hold(who: &AccountId, force: Fortitude) -> Self::Balance {
        Balances::reducible_total_balance_on_hold(who, force)
    }
    #[inline]
    ...
    fn hold_available(reason: &Self::Reason, who: &AccountId) -> bool {
        Balances::hold_available(reason, who)
    }
}
