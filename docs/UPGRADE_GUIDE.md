...
# 3. Verify total VRS token supply on-chain via pallet balances query
curl -s -H "Content-Type: application/json" -d '{"id":1, "jsonrpc":"2.0", "method": "state_getStorage", "params":["0x1a41aa1569382218d61394a821e272a85702221609e08398e1f57279c782b17f"]}' http://localhost:9944
```
