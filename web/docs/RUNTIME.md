...
| **Token Symbol** | `VRDX` | Native Verdis Utility & Governance Token |
| **Token Decimals** | `9` | 1 VRDX = 1,000,000,000 Planck (Base Unit) |
| **SS58 Address Format** | `909` | Address prefix format for SS58 encoding |
| **Chain ID** | `909` | Network identifier |
| **Total Token Supply** | `100,000,000,000 VRDX` | 100 Billion VRDX hard supply cap |
...
* **Index:** `5`
* **Purpose:** Native currency ledger management for VRDX balances, account locks, holds, free vs reserved balances, and transfer dispatches.
* **Config Parameters:**
  * `ExistentialDeposit`: `10,000,000 Planck` (0.01 VRDX). Prevents state bloat by pruning accounts falling below this limit.
  * `MaxLocks`: `50`.
  * `MaxReserves`: `50`.
...
* **Config Parameters:**
  ...
  * `WeightToFee`: Converts execution weight to VRDX tokens dynamically.
...
* **Config Parameters:**
  * `BaseDeposit`: `1,000,000,000 Planck` (1 VRDX base deposit).
...
* **Config Parameters:**
  * `MaxValidators`: `101`.
  * `MinValidatorStake`: `100,000 VRDX` (100,000,000,000,000 Planck).
  * `MinNominatorStake`: `100 VRDX` (100,000,000,000 Planck).
  * `UnbondingPeriod`: `28 sessions` (~28 hours).

#### 13. AMM-DEX (`pallet_amm_dex`)
* **Index:** `12`
* **Purpose:** Native automated market maker liquidity pool engine allowing decentralized swapping between VRDX and custom eco-tokens.
* **Config Parameters:**
...
* **Config Parameters:**
  * `MaxSupply`: `100,000,000,000 VRDX`.
...
* **Config Parameters:**
  * `MinVestedTransfer`: `1,000 VRDX` (1,000,000,000,000 Planck).
...
The total supply of Verdis Chain is **100,000,000,000 VRDX** (100 Billion VRDX) initialized at genesis across 6 key allocations:

```
+-------------------------------------------------------------------+
|               VERDIS GENESIS DISTRIBUTION (100B VRDX)              |
+-------------------------------------------------------------------+
| [Community Allocation]          35,000,000,000 VRDX (35.0%)        |
| [Treasury & Staking Rewards]    30,000,000,000 VRDX (30.0%)        |
| [Core Team]                     15,000,000,000 VRDX (15.0%)        |
| [Strategic Investors]           10,000,000,000 VRDX (10.0%)        |
| [Liquidity Pools]                5,000,000,000 VRDX  (5.0%)        |
| [Advisors & Ecosystem Airdrop]   5,000,000,000 VRDX  (5.0%)        |
+-------------------------------------------------------------------+
```

### Genesis Token Distribution Table

| Bucket | Allocation (VRDX) | Allocation (Planck) | Percentage | Vesting Condition / Lockup |
| :--- | :--- | :--- | :--- | :--- |
| **Community** | 35,000,000,000 VRDX | 35,000,000,000,000,000,000 | 35.0% | 10% unlocked at TGE, remainder linear 36 months |
| **Treasury + Staking** | 30,000,000,000 VRDX | 30,000,000,000,000,000,000 | 30.0% | On-chain governance controlled emission over 10 years |
| **Core Team** | 15,000,000,000 VRDX | 15,000,000,000,000,000,000 | 15.0% | 12-month cliff, 36-month linear vesting |
| **Investors** | 10,000,000,000 VRDX | 10,000,000,000,000,000,000 | 10.0% | 6-month cliff, 18-month linear vesting |
| **Liquidity Pools** | 5,000,000,000 VRDX | 5,000,000,000,000,000,000 | 5.0% | 100% unlocked at TGE for AMM DEX initial liquidity |
| **Advisors + Airdrop**| 5,000,000,000 VRDX | 5,000,000,000,000,000,000 | 5.0% | 20% unlocked at TGE, 12-month linear vesting |
| **Total** | **100,000,000,000 VRDX**| **100,000,000,000,000,000,000** | **100.0%** | Hard capped total initial supply |
