...
impl Account {
    ...
    fn from_keypair(name: &str, pin: &str, keypair: &Keypair) -> CoreResult<Self> {
        let address = crate::ss58::encode_address(&keypair.public, crate::ss58::VERDIS_SS58_PREFIX);
...
mod tests {
    ...
    #[test]
    fn test_from_seed() {
        let seed = "a1a2a3a4a5a6a7a8a9a0b1b2b3b4b5b6b7b8b9b0c1c2c3c4c5c6c7c8c9d0d1";
