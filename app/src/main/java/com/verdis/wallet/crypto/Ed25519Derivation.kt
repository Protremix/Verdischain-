...
object Ed25519Derivation {
    ...
    fun derivePublicKey(seed: ByteArray): ByteArray {
        ...
        aBytes[0] = (aBytes[0].toInt() and 0xF8).toByte() // clear bits 0,1,2
        aBytes[31] = (aBytes[31].toInt() and 0x7F).toByte() // clear bit 255
        aBytes[31] = (aBytes[31].toInt() or 0x40).toByte()  // set bit 254
