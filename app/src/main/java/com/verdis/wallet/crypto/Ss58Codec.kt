...
object Ss58Codec {
    ...
    /**
     * Computes 2-byte checksum using BouncyCastle BLAKE2b-256 (Substrate standard).
     */
    fun computeChecksum(prefixBytes: ByteArray, publicKey: ByteArray): ByteArray {
        // Use BouncyCastle BLAKE2b-256 — the Substrate SS58 standard.
        // Ensures addresses match on-chain exactly. No SHA-256 fallback.
        val digest = org.bouncycastle.crypto.digests.Blake2bDigest(256)
        digest.update(SS58_PREFIX_BYTES, 0, SS58_PREFIX_BYTES.size)
