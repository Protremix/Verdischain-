...
object TwoxHasher {
    ...
    fun twox64Hex(input: String): String = twox64(input.toByteArray(Charsets.UTF_8)).toHexString()
    fun twox128Hex(input: String): String = twox128(input.toByteArray(Charsets.UTF_8)).toHexString()
