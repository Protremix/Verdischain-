    ...
    Extension: TransactionExtension<Call>,
{
    ...
    type TransactionExtensionPipelines =
        sp_runtime::traits::ExtensionVariant<Extension, sp_runtime::traits::InvalidVersion>;
}
...
where
    ...
    Call: Decode + DecodeWithMemTracking + Dispatchable,
    Extension: Decode + DecodeWithMemTracking + TransactionExtension<Call>,
{
    fn deserialize<D>(de: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'a>,
    {
        // sdk 48 decodes the bytes directly instead of delegating to an inner
        // deserialize; that keeps this impl independent of the struct's const
        // generic (MAX_CALL_SIZE) and its ExtensionOtherVersions parameter.
