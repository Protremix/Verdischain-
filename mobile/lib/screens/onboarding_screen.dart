...
class _OnboardingScreenState extends State<OnboardingScreen> with SingleTickerProviderStateMixin {
  ...
  void _showCreateWallet(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Text('Creating Wallet', style: TextStyle(color: Colors.white)),
  ...
  void _showMnemonicDialog(BuildContext context, String mnemonic) {
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        backgroundColor: const Color(0xFF0D1410),
        title: Text('Save Your Mnemonic', style: TextStyle(color: Colors.white)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Container(
  ...
  void _showImportWallet(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        backgroundColor: const Color(0xFF0D1410),
        title: Text('Import Wallet', style: TextStyle(color: Colors.white)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(
